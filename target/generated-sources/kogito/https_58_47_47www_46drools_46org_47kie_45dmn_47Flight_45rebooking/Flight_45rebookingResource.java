...
@RestController
@RequestMapping("/Flight-rebooking")
public class Flight_45rebookingResource {
    ...
    public ResponseEntity<?> dmn(@RequestBody(required = false) java.util.Map<String, Object> variables, HttpServletResponse httpResponse) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://www.drools.org/kie-dmn/Flight-rebooking", "Flight-rebooking");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://www.drools.org/kie-dmn/Flight-rebooking", "Flight-rebooking", decisionResult);
        return extractContextIfSucceded(result);
    }

    @GetMapping(produces = MediaType.APPLICATION_XML_VALUE)
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Flight-rebooking") + ".dmn_nologic")));
    }
